...
//   const response = await fetch("https://api.thecatapi.com/v1/breeds?limit=10&page=0", {headers: {
//     'x-api-key': API_KEY
//   }});
...
function _initialLoad() {
  _initialLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var defaultSelect, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          defaultSelect = breedSelect.appendChild(document.createElement("option"));
          defaultSelect.textContent = "Please select a breed";
          defaultSelect.setAttribute("value", "default");
          _context2.next = 5;
          return _axios.default.get("/v1/breeds?limit=100&page=0");
        case 5:
...
function createCarousel(data) {
  data.forEach(function (cat) {
    console.log(cat);
    var item = Carousel.createCarouselItem(cat.url, "Picture of ".concat(cat.name), cat.id);
    Carousel.appendCarousel(item);
  });
}
function axiosHandleSelection(e) {
  ...
  function _getBreedsInfo() {
    _getBreedsInfo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var specificBreeds, _iterator, _step, cat, facts;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            _iterator = _createForOfIteratorHelper(specificBreeds.data);
            try {
...
function _getFavourites() {
  _getFavourites = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var favs, favoriteImgs, _iterator2, _step2, img, cat, name;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 2:
          ...
          favoriteImgs = [];
          console.log(favs);
          _iterator2 = _createForOfIteratorHelper(favs.data);
          _context4.prev = 6;
          _iterator2.s();
        case 8:
          ...
          img = _step2.value;
          _context4.next = 12;
          return _axios.default.get("v1/images/".concat(img.image_id));
        case 12:
          cat = _context4.sent;
          name = cat.data.breeds[0].name;
          img.image.name = name;
